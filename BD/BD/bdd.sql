...
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente` (
  ...
  `rut` INT(8) NULL COMMENT 'Rut cliente',
  `dv` CHAR(1) NULL COMMENT 'Dígito verificador cliente',
  `nomb` VARCHAR(128) NULL COMMENT 'Nombres de cliente',
  `apells` VARCHAR(128) NULL COMMENT 'Apellidos del cliente',
  `fenac` DATE NULL COMMENT 'Fecha nacimiento del cliente',
  `fevalde` DATE NULL COMMENT 'Fecha de activación del cliente',
  `Correo` VARCHAR(128) NULL COMMENT 'Correo electronico Cliente',
  PRIMARY KEY (`idclie`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Empresa` (
  ...
  `rutemp` INT(8) NULL COMMENT 'Numero identificador de la empresa rut',
  ...
  `fevalde` DATE NULL COMMENT 'Fecha de activación empresa en el sistema',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Estados` (
  ...
  `descest` VARCHAR(128) NULL COMMENT 'Descripcion  del estado',
  PRIMARY KEY (`idest`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Usuario` (
  ...
  `Estados_idest` INT(5) NOT NULL COMMENT 'Foring key yalba estados' /* comment truncated */ /*
*/,
  PRIMARY KEY (`idus`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`EmprGeo` (
  `idempgeo` INT NOT NULL COMMENT 'Prymary key Id empresa geocalización',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Stock` (
  `idstock` INT NOT NULL COMMENT 'Primary key tabla Stock',
  `totalpro` INT NULL COMMENT 'Total numero de producto',
  `restpro` INT NULL COMMENT 'Resto Producto',
  PRIMARY KEY (`idstock`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Direccion` (
  ...
  `direccion` VARCHAR(128) NULL COMMENT 'Nombre de la direccion de la empresa',
...
CREATE TABLE IF NOT EXISTS `mydb`.`SubFamilia` (
  ...
  `nomsubfam` VARCHAR(128) NULL COMMENT 'Nombre SubCategoria ',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Producto` (
  ...
  `descest` VARCHAR(128) NULL COMMENT 'Descripción de estado inactivo/activo',
  ...
  `Stock_idstock` INT NOT NULL COMMENT 'Foreing key tabla stock',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Visita` (
  ...
  `numvisi` INT NULL COMMENT 'AutoInscrementable de numero de visitar pagina empresa',
  `Empresa_idemp` INT(5) NOT NULL COMMENT 'Foreing Key Tabla Empresa',
